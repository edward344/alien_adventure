...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self,pos,imagesFiles,soundsFiles):
        ...
        self.walkImages = (images["playerWalk01"],images["playerWalk02"],
                            images["playerWalk03"],images["playerWalk04"],images["playerWalk05"],
                            images["playerWalk06"],images["playerWalk07"],images["playerWalk08"],
                            images["playerWalk09"],images["playerWalk10"],images["playerWalk11"])
